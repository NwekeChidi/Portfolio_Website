                                    ...
                                    var i;!function(t){
                                        ...
                                        class s{
                                            constructor(t,e,n){
                                                ...
                                                t.addEventListener("click",this.inputClickHandler)}inputBlur(){
                                                    this.isPure=!1,this._handleInputAction()}inputInput(){
                                                        this._handleInputAction()}inputClick(){
                                                            this._handleInputAction()}initValidation(){
                                                                this._handleInputAction()}_handleInputAction(){
                                                                    let t=!0;
                                                                    if(this.validations.forEach(( e => {
                                                                        ...
                                                                        a(this.input)){
                                                                            ...
                                                                            if(t){
                                                                                ...
                                                                                if(i.forEach((t=>t.dataset.sbCanSubmit="no")),this.isPure)return this.onChange(),
                                                                            ...
                                                                            this.input.classList.add("is-invalid")}this.onChange()}reset(){
                                                                                                        ...
                                                                                                        try{
                                                                                                            console.log(u(E)),d?yield(n={token:b,submissionObject:u(E)},t(void 0,void 0,void 0,(function*(){
                                                                                                                const e=yield((e,n) => t(void 0,void 0,void 0,(function*(){
                                                                                                                    const t=JSON.stringify(n),i=new Headers({"Content-Type":"application/json"}), s = { 
                                                                                                                        status : 200
                                                                                                                    };
                                                                                                                ...
                                                                                                                }catch(t){console.error(t),v.classList.remove("d-none")}
                                                                                                                var n},new((s=void 0)||(s=Promise))((function(t,e){
                                                                                                                    function r(t){try{d(a.next(t))}catch(t){e(t)}}function o(t){
                                                                                                                        try{
                                                                                                                            d(a.throw(t))}catch(t){e(t)}}function d(e){
                                                                                                                                var n;e.done?t(e.value):(n=e.value,n instanceof s?n:new s((function(t){
                                                                                                                                    t(n)}))).then(r,o)}d((a=a.apply(n,i||[])).next())}));var n,i,s,a},L=t=>y(t);m.addEventListener("click",L);const w=()=>{E.reduce(((t,n)=>{if(a(n)){
                                                                                                                                        const i=n.parentElement.parentElement,s=e("input",i);
                                                                                                                                        return t&&s.reduce(((t,e)=>t||"yes"===e.dataset.sbCanSubmit),!1)}return"yes"===n.dataset.sbCanSubmit?t&&!0:t&&!1}),!0)?m.classList.remove("disabled"):m.classList.add("disabled")};
                                                                                                                                        return c.forEach((t=>t.initValidation())),w(),{tearDown:()=>{m.removeEventListener("click",L),f.classList.add("d-none"),v.classList.add("d-none"),m.classList.remove("d-none"),m.classList.add("disabled"),E.forEach((t=>{
                                                                                                                                            t.removeAttribute("disabled")})),c.forEach((t=>t.tearDown()))}}},u=t=>{const e={};return t.forEach((t=>{if("checkbox"===t.type||"radio"===t.type)return e[t.name]||(e[t.name]={}),void(e[t.name][t.id]=t.disabled?"DISABLED":t.checked.toString());e[t.id]=t.value})),e},h="%c############################# Start Bootstrap Forms #############################\n###                                                                           ###\n###    To enable this form using Start Bootstrap Forms, simply sign up at:    ###\n###                                                                           ###\n###               https://startbootstrap/solution/contact-forms               ###\n###                                                                           ###\n#################################################################################",p="color: white; font-style: italic; background-color: #dd3d31; padding: 2px;"})();